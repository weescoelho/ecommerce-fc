...
import (
	...
	_ "github.com/go-sql-driver/mysql" // _ -> ignora o uso direto da dependencia dentro do projeto
	"github.com/weescoelho/ecommerce-fc/goapi/internal/database"
	"github.com/weescoelho/ecommerce-fc/goapi/internal/service"
	"github.com/weescoelho/ecommerce-fc/goapi/internal/webserver"
)
...
func main() {
	...
	//Definição das rotas usando o Chi
	c := chi.NewRouter()
